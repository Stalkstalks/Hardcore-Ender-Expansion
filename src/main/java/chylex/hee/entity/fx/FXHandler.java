...
public final class FXHandler {
    ...
    public static void handleBasic(World world, EntityClientPlayerMP player, FXType.Basic fx, double x, double y,
            double z) {
        switch (fx) {
            case ESSENCE_ALTAR_SMOKE:
                for (int a = 0; a < 15; a++) world.spawnParticle(
                        "largesmoke",
                        x + randCenter(0.5D),
                        y + 0.6D + rand.nextDouble() * 0.25D,
                        z + randCenter(0.5D),
                        0D,
                        0.15D,
                        0D);
            ...
            case LASER_BEAM_DESTROY:
                ...
                for (int a = 0; a < 10; a++) {
                    for (String pt : particles) world.spawnParticle(
                            pt,
                            x + randCenter(0.5D),
                            y + randCenter(0.5D),
                            z + randCenter(0.5D),
            ...
            case DUNGEON_PUZZLE_BURN:
                for (int a = 0; a < 6; a++) world.spawnParticle(
                        "flame",
                        x + randCenter(0.3D),
                        y + 0.6D * rand.nextDouble(),
                        z + randCenter(0.3D),
                        0D,
                        0.04D,
                        0D);
            ...
            case GEM_LINK:
                for (int a = 0; a < 25; a++) HardcoreEnderExpansion.fx.portalOrbiting(
                        world,
                        x + 0.5D,
                        y + 0.38D + rand.nextDouble() * 0.6D,
                        z + 0.5D,
                        rand.nextDouble() * 0.045D + 0.015D);
                world.playSound(
                        x + 0.5D,
                        y + 1D,
                        z + 0.5D,
                        "hardcoreenderexpansion:environment.gem.link",
                        1F,
                        rand.nextFloat() * 0.02F + 0.64F,
                        false);
                break;
            ...
            case GEM_TELEPORT_TO:
                ...
                world.playSound(
                        ...
                        "mob.endermen.portal",
                        1.2F,
                        world.rand.nextFloat() * 0.05F + 0.85F,
                        false);
                break;
            ...
            case ENDER_PEARL_FREEZE:
                for (double xx = x - 5; xx <= x + 5; xx++) {
                    for (double yy = y - 5; yy <= y + 5; yy++) {
                        for (double zz = z - 5; zz <= z + 5; zz++) {
                            ...
                            for (int i = 0; i < 2; ++i) world.spawnParticle(
                                    "snowballpoof",
                                    xx + rand.nextDouble() - 0.5D,
                                    yy,
                                    zz + rand.nextDouble() - 0.5D,
                                    0D,
                                    0D,
                                    0D);
                        }
                ...
                world.playSound(
                        ...
                        y,
                        z,
                        "hardcoreenderexpansion:environment.random.freeze",
                        1F,
            ...
            case IGNEOUS_ROCK_MELT:
                for (int a = 0; a < 40; a++) HardcoreEnderExpansion.fx.flame(
                        player.worldObj,
                        x + randCenter(1.25D),
                        y + randCenter(1.25D),
                        z + randCenter(1.25D),
            ...
            case ENDERMAN_BLOODLUST_TRANSFORMATION:
                for (int a = 0; a < 20; a++) world.spawnParticle(
                        "largesmoke",
                        x + randCenter(0.3D),
                        y + rand.nextDouble() * 2.8D,
                        z + randCenter(0.3D),
                        0D,
                        0D,
                        0D);
            ...
            case LOUSE_ARMOR_HIT:
                for (int a = 0; a < 10; a++) world.spawnParticle(
                        "magicCrit",
                        x + randCenter(0.4D),
                        y + rand.nextDouble() * 0.45D,
                        z + randCenter(0.4D),
                        randCenter(0.2D),
                        randCenter(0.2D),
                        randCenter(0.2D));
            ...
            case HOMELAND_ENDERMAN_TP_OVERWORLD:
                for (int a = 0; a < 50; a++) {
                    HardcoreEnderExpansion.fx.omnipresent(
                            "portal",
                            world,
                            x + randCenter(1D),
                            y + rand.nextDouble() * 2.9,
                            z + randCenter(1D),
                            randCenter(0.1D),
                            randCenter(0.05D),
                            randCenter(0.1D));
                ...
                for (int a = 120 + rand.nextInt(30); a > 0; a--) {
                    HardcoreEnderExpansion.fx.omnipresent(
                            ...
                            world,
                            x + randCenter(1D),
                            y + rand.nextDouble() * rand.nextDouble() * 60D,
                            z + randCenter(1D),
                            randCenter(0.1D),
                            randCenter(0.05D),
                            randCenter(0.1D));
            ...
            case FIRE_FIEND_FLAME_ATTACK:
                for (int a = 0; a < 20; a++) HardcoreEnderExpansion.fx
                        .flame(world, x + randCenter(0.9D), y + rand.nextDouble() * 1.8D, z + randCenter(0.9D), 10);
    ...
    public static void handleEntity(World world, EntityClientPlayerMP player, FXType.Entity fx, double x, double y,
            double z, float width, float height) {
        width *= 0.75F; // compensate for incorrect rand calculation

        switch (fx) {
            case CHARM_CRITICAL:
                for (int a = 0; a < 12; a++) world.spawnParticle(
                        "crit",
                        x + randCenter(width),
            ...
            case CHARM_WITCH:
                for (int a = 0; a < 18; a++) world.spawnParticle(
                        "witchMagic",
                        x + randCenter(width),
                        y + rand.nextDouble() * height,
                        z + randCenter(width),
            ...
            case CHARM_LAST_RESORT:
                for (int a = 0; a < 35; a++) world.spawnParticle(
                        "smoke",
                        x + randCenter(width * 1.25D),
                        y + rand.nextDouble() * height,
                        z + randCenter(width * 1.25D),
                        randCenter(0.1D),
                        randCenter(0.1D),
                        randCenter(0.1D));
                for (int a = 0; a < 75; a++) HardcoreEnderExpansion.fx.portalBig(
                        world,
                        x + randCenter(width * 1.25D),
                        y + rand.nextDouble() * height,
                        z + randCenter(width * 1.25D),
            ...
            case GEM_TELEPORT_FROM:
                for (int a = 0; a < 20; a++) world.spawnParticle(
                        "largesmoke",
                        x + randCenter(width * 1.2D),
                        y + rand.nextDouble() * height * 0.9D,
                        z + randCenter(width * 1.2D),
                        0D,
                        0.04D,
                        0D);
            ...
            case ORB_TRANSFORMATION:
                ...
                world.playSound(
                        ...
                        y,
                        z,
                        "hardcoreenderexpansion:block.random.transform",
                        1.4F,
            ...
            case LOUSE_REGEN:
                for (int a = 0; a < 6; a++) HardcoreEnderExpansion.fx.aura(
                        world,
                        x + randCenter(width),
                        y + rand.nextDouble() * height,
                        z + randCenter(width),
            ...
            case HOMELAND_ENDERMAN_RECRUIT:
                for (int a = 0; a < 25; a++) HardcoreEnderExpansion.fx.omnipresent(
                        "smoke",
                        world,
                        x + randCenter(width),
                        y + rand.nextDouble() * height,
                        ...
                        randCenter(0.05D),
                        randCenter(0.05D));
                for (int a = 0; a < 8; a++) HardcoreEnderExpansion.fx.omnipresent(
                        "largesmoke",
                        world,
                        x + randCenter(width),
                        y + rand.nextDouble() * height,
            ...
            case BABY_ENDERMAN_GROW:
                for (int a = 0; a < 20; a++) HardcoreEnderExpansion.fx.omnipresent(
                        "smoke",
                        world,
                        x + randCenter(width),
                        y + rand.nextDouble() * height,
            ...
            case ENDER_GUARDIAN_DASH:
                for (int a = 0; a < 50; a++) HardcoreEnderExpansion.fx.portalBig(
                        world,
                        x + randCenter(width),
                        y + rand.nextDouble() * height,
                        z + randCenter(width),
            ...
            case SIMPLE_TELEPORT_NOSOUND:
                for (int a = 0; a < 30; a++) HardcoreEnderExpansion.fx.omnipresent(
                        "portal",
                        world,
                        x + randCenter(width),
                        y + rand.nextDouble() * height,
                        ...
                        randCenter(0.15D),
                        randCenter(0.15D));
                if (fx != FXType.Entity.SIMPLE_TELEPORT_NOSOUND)
                    world.playSound(x, y, z, "mob.endermen.portal", 1F, 1F, false);
                break;

            case SANCTUARY_OVERSEER_SINGLE:
                for (int a = 0; a < 20; a++) HardcoreEnderExpansion.fx.portalBig(
                        world,
                        x + randCenter(width * 2D),
                        y + rand.nextDouble() * height,
                        z + randCenter(width * 2D),
                        randCenter(0.5D),
                        randCenter(0.5D),
                        randCenter(0.5D));
                break;
    ...
    public static void handleLine(World world, EntityClientPlayerMP player, FXType.Line fx, double x1, double y1,
        ...
        switch (fx) {
            ...
            case CHARM_DAMAGE_REDIRECTION:
                ...
                for (int a = 0; a < len * 2D; a++) {
                    for (int b = 0; b < 3; b++) HardcoreEnderExpansion.fx.magicCrit(
                            world,
                            x1 + randCenter(0.4D),
                            y1 + 0.2D + randCenter(0.4D),
                            z1 + randCenter(0.4D),
                            randCenter(0.1D),
                            randCenter(0.1D),
                            randCenter(0.1D),
            ...
            case DRAGON_EGG_TELEPORT:
                ...
                for (int a = 0; a < len * 4D; a++) {
                    for (int b = 0; b < 4; b++) HardcoreEnderExpansion.fx.portalBig(
                            world,
                            x1,
                            y1,
                            z1,
            ...
            case LOUSE_HEAL_ENTITY:
                ...
                for (int a = 0; a < len * 8D; a++) {
                    HardcoreEnderExpansion.fx.aura(
                            world,
                            x1 + randCenter(0.1D),
                            y1 + randCenter(0.1D),
                            z1 + randCenter(0.1D),
            ...
            case DUNGEON_PUZZLE_TELEPORT:
                ...
                for (int a = 0, particleAmt = fx == FXType.Line.DUNGEON_PUZZLE_TELEPORT ? 256 : 128; a
                        < particleAmt; a++) {
            ...
            case HOMELAND_ENDERMAN_GUARD_CALL:
                ...
                for (int a = 0; a < len * 4D; a++) {
                    if (rand.nextBoolean()) HardcoreEnderExpansion.fx.portalColor(
                            world,
                            x1 + randCenter(0.25D),
                            y1 + randCenter(0.25D),
                            z1 + randCenter(0.25D),
            ...
            case FIRE_FIEND_GOLEM_CALL:
                ...
                for (int a = 0; a < len * 2D; a++) {
                    if (rand.nextBoolean()) HardcoreEnderExpansion.fx.flame(
                            world,
                            x1 + randCenter(0.1D),
                            y1 + randCenter(0.1D),
                            z1 + randCenter(0.1D),
