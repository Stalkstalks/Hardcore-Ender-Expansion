...
public class EntityAltarOrbFX extends EntityFX {
    ...
    private static final ResourceLocation tex = new ResourceLocation(
            "hardcoreenderexpansion:textures/particles/altar_orb.png");
    ...
    public EntityAltarOrbFX(World world, double x, double y, double z, double targetX, double targetY, double targetZ,
    ...
    public void onUpdate() {
        ...
        double dist = Math.sqrt(
                MathUtil.square(trueX - targetX) + MathUtil.square(trueY - targetY) + MathUtil.square(trueZ - targetZ));
