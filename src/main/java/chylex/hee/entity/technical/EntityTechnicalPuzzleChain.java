    ...
    public void onUpdate() {
        ...
        if (ticksExisted % 8 == 1) {
            ...
            if (tmpPos.getBlock(worldObj) == BlockList.dungeon_puzzle) {
                if (((BlockDungeonPuzzle) BlockList.dungeon_puzzle)
                        .updateChain(worldObj, tmpPos.x, tmpPos.y, tmpPos.z, dir)) {
                ...
                ((BlockDungeonPuzzle) BlockList.dungeon_puzzle).checkWinConditions(
                        worldObj,
                        tmpPos.x - Direction.offsetX[dir],
                        tmpPos.y,
                        tmpPos.z - Direction.offsetZ[dir]);
                setDead();
            }
        }
    }
