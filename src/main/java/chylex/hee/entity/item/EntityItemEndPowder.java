...
public class EntityItemEndPowder extends EntityItem {
    ...
    public void onUpdate() {
        ...
        if (++checkTimer > 10) {
            ...
            ingredientList.put(
                    Sets.newHashSet(Items.gold_ingot, ItemList.ectoplasm, Items.string),
                    new ItemStack(ItemList.curse_amulet));

            List<EntityItem> nearbyItems = worldObj
                    .getEntitiesWithinAABB(EntityItem.class, boundingBox.expand(1.8D, 1.8D, 1.8D));
