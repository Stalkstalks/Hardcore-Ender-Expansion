...
public class RandomNameGenerator {
    ...
    public static void generateEntityName(EntityLiving entity, int length) {
        if (!entity.hasCustomNameTag()) entity.setCustomNameTag(
                generate(entity.getRNG(), length) + StatCollector.translateToLocal("namegenerator.middle")
    ...
    public static final HeeTest $debugTest = new HeeTest() {
        ...
        public void run(String... args) {
            for (int a = 0; a < 50; a++)
                Log.debug("> " + RandomNameGenerator.generate(world.rand, 4 + world.rand.nextInt(8)));
        }
    };
}
