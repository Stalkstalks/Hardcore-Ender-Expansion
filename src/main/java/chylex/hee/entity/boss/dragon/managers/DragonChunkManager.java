...
public class DragonChunkManager implements LoadingCallback {
    ...
    public static void ping(EntityBossDragon dragon) {
        ...
        if (ticket == null) {
            ticket = instance.ticket = ForgeChunkManager
                    .requestTicket(HardcoreEnderExpansion.instance, dragon.worldObj, Type.ENTITY);
    ...
    public static void release(EntityBossDragon dragon) {
        ...
        WorldDataHandler.<DragonSavefile>get(DragonSavefile.class)
                .setLastDragonChunk(dragon.chunkCoordX, dragon.chunkCoordZ);
    ...
    public void onWorldLoad(WorldEvent.Load e) {
        if (!e.world.isRemote && e.world.provider.dimensionId == 1) {
            ...
            List<EntityBossDragon> list = e.world.getEntitiesWithinAABB(
                    EntityBossDragon.class,
                    AxisAlignedBB.getBoundingBox(xx, -32, zz, xx + 16, 512, zz + 16));
