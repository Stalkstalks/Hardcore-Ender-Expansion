...
public class TargetPositionSetEvent {
    ...
    public TargetPositionSetEvent(EntityPlayer currentEntityTarget, double oldTargetX, double oldTargetY,
            double oldTargetZ, double newTargetX, double newTargetY, double newTargetZ) {
