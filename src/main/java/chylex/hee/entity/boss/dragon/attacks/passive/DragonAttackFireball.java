...
public class DragonAttackFireball extends DragonPassiveAttackBase {
    ...
    public void update() {
        ...
        else if (dragon.target != null && ++timer
                >= (24 - dragon.worldObj.difficultySetting.getDifficultyId() * 4) + (dragon.angryStatus ? 5 : 20)
                        - (ModCommonProxy.opMobs ? 5 : 0)
                        - ((100 - dragon.attacks.getHealthPercentage()) >> 4)) {
