...
public class DragonShotManager {
    ...
    public void shoot() {
        ...
        EntityFireball e = type == ShotType.FIREBALL
                ? new EntityProjectileDragonFireball(
                        dragon.worldObj,
                        dragon,
                        xDiff,
                        yDiff,
                        zDiff,
                        dragon.angryStatus ? 1.5F : 1F,
                        random,
                        (dragon.angryStatus ? 2.8F : 2.5F) + (ModCommonProxy.opMobs ? 0.7F : 0F))
                : null;
        if (e == null) return;
