...
public class DragonRewardManager {
    ...
    public void spawnEssence(World world, int x, int z) {
        ...
        double fx = x + Math.cos(ang) * len, fz = z + Math.sin(ang) * len;
        EntityItem item = new EntityItem(
                world,
                fx + world.rand.nextDouble() - 0.5D,
                128,
                fz + world.rand.nextDouble() - 0.5D,
                new ItemStack(ItemList.essence, getEssencePerTick(), 0));
