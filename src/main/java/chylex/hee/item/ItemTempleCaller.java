...
public class ItemTempleCaller extends ItemAbstractEnergyAcceptor {
    ...
    public ItemStack onItemRightClick(ItemStack is, World world, EntityPlayer player) {
        ...
        if (player.dimension != 1 || !player.inventory.hasItem(Item.getItemFromBlock(Blocks.dragon_egg))
                || !WorldDataHandler.<DragonSavefile>get(DragonSavefile.class).isDragonDead()) {
