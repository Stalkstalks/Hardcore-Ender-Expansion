...
public class ItemPotionOfPurity extends ItemAbstractPotion {
    ...
    public void applyEffectDrunk(ItemStack is, World world, EntityPlayer player) {
        for (EntityTechnicalCurseEntity curse : (List<EntityTechnicalCurseEntity>) world
                .getEntitiesWithinAABB(EntityTechnicalCurseEntity.class, player.boundingBox.expand(0.5D, 0.5D, 0.5D))) {
