...
public class ItemSpecialEffects extends Item {
    ...
    public void registerIcons(IIconRegister iconRegister) {
        ...
        char c = 'a';
        for (int a = 10; a < 18; a++)
            iconArray[a] = iconRegister.registerIcon("hardcoreenderexpansion:altar_glyph_" + (c++));
        ...
        for (int a = 20; a <= biomePointEnd; a++)
            iconArray[a] = iconRegister.registerIcon("hardcoreenderexpansion:biome_" + (a - 20));
