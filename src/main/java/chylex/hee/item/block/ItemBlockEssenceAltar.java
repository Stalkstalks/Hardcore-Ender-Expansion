...
public class ItemBlockEssenceAltar extends ItemBlockEnhanceableTile {
    ...
    public String getUnlocalizedName(ItemStack is) {
        ...
        if (ModCommonProxy.hardcoreEnderbacon && essenceType == EssenceType.DRAGON)
            return "tile.essenceAltar.dragon.bacon";
        return "tile.essenceAltar." + (essenceType == null ? EssenceType.INVALID : essenceType).essenceNameLowercase;
    }

    @Override
    public boolean placeBlockAt(ItemStack is, EntityPlayer player, World world, int x, int y, int z, int side,
