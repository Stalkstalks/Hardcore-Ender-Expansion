...
public class C22EffectLine extends AbstractClientPacket {
    ...
    public C22EffectLine(FXType.Line type, Entity entity1, Entity entity2) {
        this(
                type,
                entity1.posX,
                entity1.posY + entity2.height * 0.5F,
                entity1.posZ,
                entity2.posX,
                entity2.posY + entity2.height * 0.5F,
                entity2.posZ);
    }

    @Override
    public void write(ByteBuf buffer) {
        buffer.writeByte(type.ordinal()).writeDouble(x1).writeDouble(y1).writeDouble(z1).writeDouble(x2).writeDouble(y2)
                .writeDouble(z2);
    }
