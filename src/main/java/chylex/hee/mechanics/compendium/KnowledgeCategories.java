...
public class KnowledgeCategories {
    ...
    public static final KnowledgeCategory OVERWORLD, DRAGON_LAIR, ENDSTONE_BLOBS, DUNGEON_TOWER, METEOROIDS,
            BIOME_ISLANDS, BIOME_ISLAND_FOREST, BIOME_ISLAND_MOUNTAINS, BIOME_ISLAND_ENCHISLAND;
    ...
    public static final KnowledgeCategory[] categoryList = new KnowledgeCategory[] {
            ...
            BIOME_ISLANDS = new KnowledgeCategory(
                    "Biome Islands",
                    new ItemStack(BlockList.special_effects, 1, BlockSpecialEffects.metaBiomeIslandIcon)),
            BIOME_ISLAND_FOREST = new KnowledgeCategory(
                    "Biome Island - Infested Forest",
                    new ItemStack(BlockList.end_terrain, 1, 0)),
            BIOME_ISLAND_MOUNTAINS = new KnowledgeCategory(
                    "Biome Island - Burning Mountains",
                    new ItemStack(BlockList.end_terrain, 1, 1)),
            BIOME_ISLAND_ENCHISLAND = new KnowledgeCategory(
                    "Biome Island - Enchanted Island",
                    new ItemStack(BlockList.end_terrain, 1, 2)) };
}
