        ...
        switch (list.getRandomItem(rand)) {
            case DEFLECTION:
                ...
                entity.setLocationAndAngles(
                        x + 0.5D,
                        entity.worldObj.getTopSolidOrLiquidBlock(MathUtil.floor(x), MathUtil.floor(z)) + 1D,
                        z + 0.5D,
                        entity.rotationYaw,
            ...
            case SLOWNESS:
                if (entity instanceof EntityLivingBase) ((EntityLivingBase) entity).addPotionEffect(
                        new PotionEffect(Potion.moveSlowdown.id, MathUtil.ceil(280f * percBroken), 1, true));
                break;

            case NAUSEA:
                if (entity instanceof EntityLivingBase) ((EntityLivingBase) entity).addPotionEffect(
                        new PotionEffect(Potion.confusion.id, MathUtil.ceil(340f * percBroken), 0, true));
                break;

            case WEAKNESS:
                if (entity instanceof EntityLivingBase) ((EntityLivingBase) entity).addPotionEffect(
                        new PotionEffect(Potion.weakness.id, MathUtil.ceil(320f * percBroken), 1, true));
                break;

            case HUNGER:
                if (entity instanceof EntityLivingBase) ((EntityLivingBase) entity)
                        .addPotionEffect(new PotionEffect(Potion.hunger.id, MathUtil.ceil(265f * percBroken), 0, true));
                break;

            case ENDERMEN:
                for (int a = 0; a < rand.nextInt(3) + 2; a++) entity.worldObj.spawnEntityInWorld(
                        new EntityMobAngryEnderman(entity.worldObj, entity.posX, entity.posY, entity.posZ));
                break;
