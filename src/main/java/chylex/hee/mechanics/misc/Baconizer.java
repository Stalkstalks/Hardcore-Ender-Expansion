...
public final class Baconizer {
    ...
    public static void load() {
        ...
        baconizeBlocks(
                new Block[] { BlockList.end_powder_ore, BlockList.endium_ore, BlockList.endium_block,
                        BlockList.enderman_head, BlockList.death_flower, BlockList.transport_beacon });

        baconizeItems(
                new Item[] { ItemList.end_powder, ItemList.endium_ingot, ItemList.adventurers_diary,
                        ItemList.knowledge_note, ItemList.altar_nexus, ItemList.temple_caller, ItemList.dry_splinter,
                        ItemList.spectral_tear, ItemList.living_matter, ItemList.scorching_pickaxe });
    ...
    public static String sentence(String text) {
        ...
        String lc = StatCollector.translateToLocal("baconizer.bacon"),
                fc = Character.toUpperCase(lc.charAt(0)) + lc.substring(1), uc = lc.toUpperCase();
