...
public class PlayerVoidChest implements IExtendedEntityProperties {
    ...
    static void register() {
        PlayerDataHandler
                .registerProperty(playerPropertyIdentifier, new IExtendedPropertyInitializer<PlayerVoidChest>() {
    ...
    public void loadNBTData(NBTTagCompound nbt) {
        NBTTagList tagItems = nbt.hasKey("items") ? nbt.getTagList("items", NBT.TAG_COMPOUND)
                : nbt.getTagList("HEE_VC_items", NBT.TAG_COMPOUND);
