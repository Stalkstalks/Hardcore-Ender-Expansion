...
public enum CharmType {
    ...
    BASIC_DEFENSE(8, 3,
            new CharmRecipe[] { new CharmRecipe(9).rune(DEFENSE, 3).prop("reducedmg", 0.10F),
    ...
    BASIC_MAGIC(11, 7,
            new CharmRecipe[] { new CharmRecipe(12).rune(MAGIC, 3).prop("exp", 1.10F),
                    new CharmRecipe(13).rune(MAGIC, 4).prop("exp", 1.20F),
                    new CharmRecipe(14).rune(MAGIC, 5).prop("exp", 1.30F) },
            new String[] { "perc-1,exp" }),

    EQUALITY(16, 9,
            new CharmRecipe[] { new CharmRecipe(18).rune(POWER).rune(AGILITY).rune(VIGOR).rune(DEFENSE).rune(MAGIC)
                    .prop("dmg", 1.08F).prop("spd", 1.05F).prop("regenspd", 0.06F).prop("reducedmg", 0.03F)
                    .prop("exp", 1.03F) },
            new String[] { "perc-1,dmg", "perc-1,spd", "perc,regenspd", "perc,reducedmg", "perc-1,exp" }),

    BLOCKING(0, 10,
            new CharmRecipe[] { new CharmRecipe(19).rune(POWER).rune(DEFENSE).rune(VOID).prop("reducedmgblock", 0.20F),
    ...
    BLOCKING_REFLECTION(1, 10,
            new CharmRecipe[] {
                    new CharmRecipe(22).rune(POWER).rune(DEFENSE).rune(VOID).rune(MAGIC).prop("reducedmgblock", 0.20F)
                            .prop("blockreflectdmg", 0.10F),
                    new CharmRecipe(23).rune(POWER).rune(DEFENSE, 2).rune(VOID).rune(MAGIC)
                            .prop("reducedmgblock", 0.32F).prop("blockreflectdmg", 0.10F),
                    new CharmRecipe(24).rune(POWER, 2).rune(DEFENSE).rune(VOID).rune(MAGIC)
                            .prop("reducedmgblock", 0.20F).prop("blockreflectdmg", 0.20F) },
            new String[] { "perc,reducedmgblock", "perc,blockreflectdmg" }),

    BLOCKING_REPULSION(2, 10,
            new CharmRecipe[] {
                    new CharmRecipe(71).rune(POWER).rune(DEFENSE).rune(VOID).rune(AGILITY).prop("reducedmgblock", 0.20F)
                            .prop("blockrepulsepower", 1),
                    new CharmRecipe(72).rune(POWER).rune(DEFENSE, 2).rune(VOID).rune(AGILITY)
                            .prop("reducedmgblock", 0.32F).prop("blockrepulsepower", 1),
                    new CharmRecipe(73).rune(POWER).rune(DEFENSE).rune(VOID).rune(AGILITY, 2)
                            .prop("reducedmgblock", 0.20F).prop("blockrepulsepower", 2), },
            new String[] { "perc,reducedmgblock", "int,blockrepulsepower" }),

    DIGESTIVE_RECOVER(3, 5,
            new CharmRecipe[] { new CharmRecipe(25).rune(POWER).rune(VIGOR).rune(VOID).prop("healthperhunger", 0.50F),
    ...
    LIFE_STEAL(5, 11,
            new CharmRecipe[] {
                    new CharmRecipe(28).rune(POWER).rune(VIGOR).rune(MAGIC).rune(VOID).prop("stealhealth", 2)
                            .prop("stealdealt", 16),
                    // new
                    // CharmRecipe(29).rune(POWER).rune(VIGOR,2).rune(MAGIC).rune(VOID).prop("stealhealth",4).prop("stealdealt",16),
                    new CharmRecipe(30).rune(POWER, 2).rune(VIGOR, 2).rune(VOID).prop("stealhealth", 2)
                            .prop("stealdealt", 10) },
    ...
    DAMAGE_REDIRECTION(14, 3, new CharmRecipe[] {
            ...
            new CharmRecipe(35).rune(AGILITY, 2).rune(DEFENSE, 2).rune(MAGIC).prop("rediramt", 0.18F)
                    .prop("redirmobs", 2),
            new CharmRecipe(36).rune(AGILITY).rune(DEFENSE, 3).rune(MAGIC).prop("rediramt", 0.30F)
                    .prop("redirmobs", 1) },
            new String[] { "perc,rediramt", "int,redirmobs" }),

    MAGIC_PENETRATION(13, 4,
            new CharmRecipe[] { new CharmRecipe(37).rune(POWER, 2).rune(MAGIC).prop("dmgtomagic", 0.10F),
    ...
    WITCHERY_HARM(12, 4, new CharmRecipe[] {
            // new
            // CharmRecipe(44).rune(POWER).rune(MAGIC).rune(VIGOR).rune(VOID).prop("badeffchance",0.08F).prop("badefflvl",1).prop("badefftime",5),
            new CharmRecipe(45).rune(POWER).rune(MAGIC).rune(VIGOR, 2).rune(VOID).prop("badeffchance", 0.09F)
                    .prop("badefflvl", 2).prop("badefftime", 5),
            new CharmRecipe(46).rune(POWER).rune(MAGIC, 2).rune(VIGOR).rune(VOID).prop("badeffchance", 0.14F)
                    .prop("badefflvl", 1).prop("badefftime", 5),
            new CharmRecipe(65).rune(POWER, 2).rune(MAGIC).rune(VIGOR).rune(VOID).prop("badeffchance", 0.09F)
                    .prop("badefflvl", 1).prop("badefftime", 10) },
            new String[] { "perc,badeffchance", "int,badefflvl", "int,badefftime" }),

    /*
     * WITCHERY_DEFENSE(9, 5, new CharmRecipe[]{ new
     * CharmRecipe(47).rune(MAGIC).rune(VIGOR).rune(VOID).rune(DEFENSE).prop("badeffreduce",10), new
     * CharmRecipe(48).rune(MAGIC).rune(VIGOR).rune(VOID).rune(DEFENSE,2).prop("badeffreduce",15) }, ""),
     */

    MAGIC_DEFENSE(10, 3,
            new CharmRecipe[] { new CharmRecipe(74).rune(DEFENSE).rune(MAGIC).rune(VOID).prop("reducemagicdmg", 0.30F),
    ...
    FALLING_PROTECTION(10, 6,
            new CharmRecipe[] { new CharmRecipe(49).rune(AGILITY, 3).rune(DEFENSE).prop("fallblocks", 3),
                    new CharmRecipe(50).rune(AGILITY, 4).rune(DEFENSE).prop("fallblocks", 6) },
            new String[] { "int,fallblocks" }),

    HASTE(1, 8,
            new CharmRecipe[] { new CharmRecipe(51).rune(AGILITY, 2).rune(VOID).prop("breakspd", 1.10F),
    ...
    SECOND_DURABILITY(12, 8,
            new CharmRecipe[] {
                    new CharmRecipe(60).rune(VIGOR).rune(MAGIC).rune(VOID).prop("recdurabilitychance", 0.28F)
                            .prop("recdurabilityamt", 0.10F),
                    new CharmRecipe(61).rune(VIGOR, 2).rune(MAGIC).rune(VOID).prop("recdurabilitychance", 0.25F)
                            .prop("recdurabilityamt", 0.18F),
                    new CharmRecipe(62).rune(VIGOR, 3).rune(MAGIC).rune(VOID).prop("recdurabilitychance", 0.22F)
                            .prop("recdurabilityamt", 0.25F),
                    new CharmRecipe(63).rune(VIGOR).rune(MAGIC, 2).rune(VOID).prop("recdurabilitychance", 0.32F)
                            .prop("recdurabilityamt", 0.16F),
                    new CharmRecipe(64).rune(VIGOR).rune(MAGIC, 3).rune(VOID).prop("recdurabilitychance", 0.44F)
                            .prop("recdurabilityamt", 0.12F) },
            new String[] { "perc,recdurabilitychance", "perc,recdurabilityamt" }),

    /*
     * VOID_RESCUE(16, 0, new CharmRecipe[]{ new CharmRecipe(15).rune(DEFENSE).rune(VOID,3).prop("voidrescue",30), new
     * CharmRecipe(16).rune(DEFENSE,2).rune(VOID,3).prop("voidrescue",20) }, ""),
     */
    ...
    SLAUGHTER_IMPACT(15, 12, new CharmRecipe[] {
            ...
            new CharmRecipe(70).rune(POWER, 2).rune(MAGIC, 2).rune(VOID).prop("impactamt", 1.00F)
                    .prop("impactrad", 6F) },
            new String[] { "perc,impactamt", "int,impactrad" }),

    LAST_RESORT(9, 7,
            new CharmRecipe[] {
                    new CharmRecipe(77).rune(DEFENSE).rune(AGILITY).rune(MAGIC).rune(VOID).prop("lastresortblocks", 6)
                            .prop("lastresortcooldown", 10),
                    new CharmRecipe(78).rune(DEFENSE).rune(AGILITY, 2).rune(MAGIC).rune(VOID)
                            .prop("lastresortblocks", 6).prop("lastresortcooldown", 6),
                    new CharmRecipe(79).rune(DEFENSE).rune(AGILITY).rune(MAGIC, 2).rune(VOID)
                            .prop("lastresortblocks", 12).prop("lastresortcooldown", 10), },
            ...
            for (CharmRecipe recipe : type.recipes) {
                if (recipe.id == damage) {
                    String tooltip = StatCollector.translateToLocal(
                            new StringBuilder().append("item.charm.").append(type.name().toLowerCase().replace("_", ""))
                    ...
                    for (int arg = 0; arg < type.tooltipArgs.length; arg++) {
                        ...
                        switch (args[0]) {
                            ...
                            case "flopb":
                                ...
                                replacement = val < 1F ? DragonUtil.formatOnePlace.format(val)
                                        : String.valueOf(Math.round(val));
                                break;
                            case "perc":
                                replacement = Math.round(100F * recipe.getProp(args[1])) + "%";
                                break;
                            case "perc1-":
                                replacement = Math.round(100F * (1F - recipe.getProp(args[1]))) + "%";
                                break;
                            case "perc-1":
                                replacement = Math.round(100F * (recipe.getProp(args[1]) - 1F)) + "%";
                                break;
                            case "int":
                    ...
                    if (!type.canBeStacked()) tooltip += "\\n" + EnumChatFormatting.DARK_GRAY
                            + StatCollector.translateToLocal("item.charm.cannotstack");
