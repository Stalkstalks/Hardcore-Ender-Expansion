...
public class BlobPopulatorPlant extends BlobPopulator {
    ...
    /**
     * Populator will know all generated blocks and use those to place ores, attempt amount will have an effect in cases
     * when the random block is not air above End Stone.
     */
