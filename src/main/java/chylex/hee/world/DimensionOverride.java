...
public final class DimensionOverride {
    ...
    public static void setup() {
        ...
        MapGenStructureIO.func_143031_a(ComponentTower.class, "hardcoreenderdragon_EndTowerC"); // OBFUSCATED register
                                                                                                // structure component
    ...
    public static void postInit() {
        if (!(BiomeGenBase.sky instanceof BiomeGenHardcoreEnd)) throw new RuntimeException(
                "End biome class mismatch, Hardcore Ender Expansion cannot proceed! Biome class: "
                        + BiomeGenBase.sky.getClass().getName());
    ...
    public static void verifyIntegrity() {
        try {
            ...
            if (cls != WorldProviderHardcoreEnd.class) throw new RuntimeException(
                    "End world provider class mismatch, Hardcore Ender Expansion cannot proceed! Provider class: "
    ...
    public static final class ChunkProviderServerOverride extends ChunkProviderServer {
        ...
        public ChunkProviderServerOverride(WorldServer world) {
            super(
                    world,
                    world.theChunkProviderServer.currentChunkLoader,
