...
public final class RavagedDungeonLoot {
    ...
    public static ItemStack[] flowerPotItems = new ItemStack[] { new ItemStack(Blocks.sapling, 1, 2), // birch sapling
    ...
    public static final WeightedLootList lootGeneral = new WeightedLootList(
            new LootItemStack[] { new LootItemStack(ItemList.end_powder).setAmount(1, 5).setWeight(100),
                    ...
                    new LootItemStack(BlockList.ravaged_brick).setAmount(1, 4)
                            .setDamage(1, BlockRavagedBrick.metaAmount - 1).setWeight(50),
    ...
    public static final WeightedLootList lootUncommon = new WeightedLootList(
            new LootItemStack[] { new LootItemStack(ItemList.end_powder).setAmount(3, 7).setWeight(80),
                    ...
                    new LootItemStack(BlockList.ravaged_brick).setAmount(2, 6)
                            .setDamage(1, BlockRavagedBrick.metaAmount - 1).setWeight(42),
                            ...
                            .addItemPostProcessor(new IItemPostProcessor() {
                                ...
                                public ItemStack processItem(ItemStack is, Random rand) {
                                    if (is.getItem() == ItemList.enhanced_ender_pearl) {
                                        ...
                                        int amount = 1 + (int) Math
                                                .abs(Math.round(rand.nextDouble() * rand.nextGaussian() * 1.5D));
    ...
    public static final WeightedLootList lootRare = new WeightedLootList(
            new LootItemStack[] { new LootItemStack(Items.iron_ingot).setAmount(3, 9).setWeight(42),
                                ...
                                public ItemStack processItem(ItemStack is, Random rand) {
                                    if (is.getItem() == ItemList.enhanced_ender_pearl) {
                                        List<EnderPearlEnhancements> availableTypes = CollectionUtil
                                                .newList(EnderPearlEnhancements.values());
                                        int amount = 1 + (int) Math
                                                .abs(Math.round(rand.nextDouble() * rand.nextGaussian() * 2.25D));
    ...
    public static final WeightedLootList lootEnd = new WeightedLootList(
            new LootItemStack[] { new LootItemStack(ItemList.end_powder).setAmount(4, 16).setWeight(31),
                    ...
                    new LootItemStack(ItemList.charm).setWeight(3) }).addItemPostProcessor(new IItemPostProcessor() {
