...
public class ComponentIsland extends ComponentLargeStructureWorld {
    ...
    public ComponentIsland(World world, Random rand, int x, int z) {
        ...
        WorldDataHandler.<WorldGenSavefile>get(WorldGenSavefile.class)
                .addElementAt(getStartX() >> 4, getStartZ() >> 4, WorldGenElement.BIOME_ISLAND);
    }
    ...
    public static final HeeTest $debugTest = new HeeTest() {
        ...
        private void generate() {
            ComponentIsland island = new ComponentIsland(
                    world,
                    world.rand,
                    (int) player.posX - 104,
                    (int) player.posZ - 104);
            island.addComponentParts(
                    world,
                    world.rand,
                    new StructureBoundingBox(-9999999, 0, -9999999, 9999999, 128, 9999999));
            HardcoreEnderExpansion.notifications
                    .report("Generated island: " + island.biomeData.getDeviationsAsString(), true);
        }
    };
}
