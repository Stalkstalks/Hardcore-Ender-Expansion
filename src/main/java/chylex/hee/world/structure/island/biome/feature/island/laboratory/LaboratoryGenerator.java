...
public final class LaboratoryGenerator {
    ...
    public void generateInWorld(LargeStructureWorld world, Random rand) {
        ...
        for (LaboratoryElement room : roomElements) {
            for (dir = 0; dir < 4; dir++) {
                if (room.connected[dir]) {
                    ...
                    LaboratoryElementPlacer
                            .generateRoomEntrance(world, rand, fromX - offX, yy, fromZ - offZ, offX != 0);
                    ...
                    while (CycleProtection.proceed()) {
                        ...
                        if (hall == null) {
                            ...
                            LaboratoryElementPlacer
                                    .generateHall(world, rand, fromX, fromZ, xx - offX, zz - offZ, yy, offX != 0);
        ...
        for (int[] array : stairs) LaboratoryElementPlacer.generateHallStairs(
                world,
                rand,
                array[0],
                array[1],
                array[2],
                Direction.offsetX[array[4]],
                array[3],
                Direction.offsetZ[array[4]]);
    }
