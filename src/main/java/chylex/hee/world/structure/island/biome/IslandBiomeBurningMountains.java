...
public class IslandBiomeBurningMountains extends IslandBiomeBase {
    ...
    protected IslandBiomeBurningMountains(int biomeID) {
        ...
        getSpawnEntries(SCORCHING).addAll(
                new SpawnEntry[] { new SpawnEntry(EntityMobFireGolem.class, 14, 10),
                        new SpawnEntry(EntityMobScorchingLens.class, 10, 6) });

        getSpawnEntries(MINE).addAll(new SpawnEntry[] { new SpawnEntry(EntityMobHauntedMiner.class, 20, 10) });
    }
