...
public class TerrainGenerator {
    ...
    private double[] initializeNoiseField(double[] densities, int x, int y, int z, int sizeX, int sizeY, int sizeZ) {
        ...
        noiseData1 = noiseGen3.generateNoiseOctaves(
                noiseData1,
                x,
                y,
                z,
                ...
                noiseScaleY / 160D,
                noiseScaleXZ / 80D);
        noiseData2 = noiseGen1.generateNoiseOctaves(
                noiseData2,
                x,
                y,
                z,
                ...
                noiseScaleY,
                noiseScaleXZ);
        noiseData3 = noiseGen2.generateNoiseOctaves(
                noiseData3,
                x,
                y,
                z,
        ...
        for (int xx = 0; xx < sizeX; ++xx) {
            for (int zz = 0; zz < sizeZ; ++zz) {
                ...
                float f2 = (100F * biome.getIslandFillFactor())
                        - MathHelper.sqrt_float(distanceX * distanceX + distanceZ * distanceZ) * 8F;
