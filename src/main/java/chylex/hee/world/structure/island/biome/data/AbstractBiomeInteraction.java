...
public abstract class AbstractBiomeInteraction {
    ...
    protected final AxisAlignedBB getIslandBoundingBox() {
        return AxisAlignedBB.getBoundingBox(
                centerX - ComponentIsland.halfSize,
                10,
                centerZ - ComponentIsland.halfSize,
                centerX + ComponentIsland.halfSize,
                120,
                centerZ + ComponentIsland.halfSize);
    }
    ...
    public static final class BiomeInteraction {
        ...
        public BiomeInteraction(String identifier, Class<? extends AbstractBiomeInteraction> interactionClass,
                int rngSource, int maxInstances) {
