...
public class HeeChallenge extends HeeAchievement {
    ...
    public IChatComponent func_150951_e() { // OBFUSCATED get name
        if (statName == null) this.statName = new ChatComponentText(
                new StringBuilder().append(StatCollector.translateToLocal("challenge.title")).append(" ")
                        .append(StatCollector.translateToLocal("challenge." + achievementId)).toString());
    ...
    public String getDescription() {
        return new StringBuilder().append(StatCollector.translateToLocal("challenge." + achievementId + ".desc"))
                .append("\n").append(EnumChatFormatting.RED)
                .append(
                        StatCollector.translateToLocal(
                                "challenge.difficulty." + AchievementManager.challengeStrings.get(achievementId)))
                .toString();
    }
}
