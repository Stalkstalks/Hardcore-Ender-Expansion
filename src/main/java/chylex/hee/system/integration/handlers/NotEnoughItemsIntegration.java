    ...
    public void integrate() {
        ...
        GuiContainerManager.inputHandlers.addFirst(new IContainerInputHandler() {
            ...
            public boolean lastKeyTyped(GuiContainer gui, char keyChar, int keyCode) {
                return CompendiumEventsClient.getInstance().isKeybindingValid()
                        && keyCode == CompendiumEventsClient.getCompendiumKeyCode()
                                ? handleItemStack(GuiContainerManager.getStackMouseOver(gui))
                                : false;
            }
