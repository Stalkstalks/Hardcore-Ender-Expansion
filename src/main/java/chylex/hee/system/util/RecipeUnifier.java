...
public final class RecipeUnifier {
    ...
    private static final Function<Object, ItemStack[]> mapToOreStack = new Function<Object, ItemStack[]>() {
        ...
        public ItemStack[] apply(Object obj) {
            if (obj instanceof ItemStack) return new ItemStack[] { (ItemStack) obj };
                ...
                return ((ArrayList<ItemStack>) obj).toArray(new ItemStack[((ArrayList) obj).size()]);
    ...
    /**
     * Aligns all ingredients next to each other, removing all null elements and resizing the ingredient array. If
     * combined with {@code pad()}, the array elements are first aligned to the beginning, and then padded.
     */
    ...
    /**
     * Converts an IRecipe to a custom recipe object. If the IRecipe class cannot be handled, the ingredient array will
     * be empty.
     */
    public Recipe unify(IRecipe recipe) {
        ...
        if (recipe instanceof ShapedRecipes) {
            ...
            ingredients = ((List<ItemStack>) ((ShapelessRecipes) recipe).recipeItems)
                    .toArray(new ItemStack[shapeless.recipeItems.size()]);
        } else if (recipe instanceof ShapedOreRecipe) {
            ingredients = J8
                    .toArray(J8.mapArray(((ShapedOreRecipe) recipe).getInput(), mapToItemStack), ItemStack.class);
            oreIngredients = J8.mapArray(((ShapedOreRecipe) recipe).getInput(), mapToOreStack);
            isShaped = true;
        } else if (recipe instanceof ShapelessOreRecipe) {
            ingredients = J8
                    .toArray(J8.mapList(((ShapelessOreRecipe) recipe).getInput(), mapToItemStack), ItemStack.class);
        ...
        return new Recipe(
                ...
                ingredients == null ? new ItemStack[0] : ingredients,
                oreIngredients,
                isShaped);
    }
    ...
    public static final class Recipe {
        ...
        /**
         * Returns the result of the crafting recipe. This should work even for non-standard recipes, but there is a
        ...
        /**
         * Returns whether the recipe is shaped. If the {@code align()} method was used in the RecipeUnifier, the
         * crafting matrix structure will not be preserved.
         */
        ...
        /**
         * Returns the ingredient array. Changes made to it are reflected in the internal object, but not in the recipe
         * itself. The array size, and whether it contains nulls or not, depend on settings of the RecipeUnifier used to
         * parse the recipe.
         */
        ...
        /**
         * If the recipe is an Ore Dictionary recipe, returns the saved list of ItemStack arrays. If not, it creates a
         * new list from the ingredient array for every call, so use {@code isOreRecipe()} first. The returned list
         * never contains null, missing/empty ingredients use an empty array instead.
         */
