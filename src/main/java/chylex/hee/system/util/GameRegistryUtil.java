...
public final class GameRegistryUtil {
    ...
    public static void registerEntity(Class<? extends Entity> entityClass, String entityName, int id,
        ...
        EntityRegistry.registerModEntity(
                ...
                entityName,
                id,
                HardcoreEnderExpansion.instance,
                trackingRange,
                1,
                true);
    }
    ...
    public static void replaceVanillaEntity(Class<? extends Entity> newEntityClass, int entityId) {
        ...
        if (name == null || EntityList.stringToClassMapping.remove(name) == null
                || EntityList.IDtoClassMapping.remove(Integer.valueOf(entityId)) == null) {
