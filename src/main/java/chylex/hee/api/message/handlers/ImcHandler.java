...
public abstract class ImcHandler {
    ...
    public static final void loadHandlers() {
        ImcHandler[] handlers = new ImcHandler[] { new ImcEssenceHandlers(), new ImcMobHandlers(), new ImcOrbHandlers(),
                new ImcTableHandlers(), new ImcWorldHandlers(), new ImcSystemHandlers() };
