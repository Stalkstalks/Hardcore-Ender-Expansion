...
public class RenderTileEndermanHead extends TileEntitySpecialRenderer {
    ...
    private static final ResourceLocation endermanHead = new ResourceLocation(
            "hardcoreenderexpansion:textures/entity/enderman_head.png");
    ...
    public void renderTileEntityAt(TileEntity tile, double x, double y, double z, float partialTickTime) {
        ...
        renderSkull(
                ((TileEntityEndermanHead) tile).getMeta(),
                ((TileEntityEndermanHead) tile).getRotation() * 360F / 16F);
        GL11.glPopMatrix();
    }
}
