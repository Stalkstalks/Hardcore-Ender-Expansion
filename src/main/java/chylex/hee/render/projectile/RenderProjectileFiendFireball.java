...
public class RenderProjectileFiendFireball extends Render {
    ...
    @Override
    public void doRenderShadowAndFire(Entity entity, double x, double y, double z, float rotationYaw,
            float partialTickTime) {
        EntityProjectileFiendFireball fireball = (EntityProjectileFiendFireball) entity;
        super.doRenderShadowAndFire(
                entity,
                getX(fireball, partialTickTime),
                y,
                getZ(fireball, partialTickTime),
                rotationYaw,
                partialTickTime);
    }
    ...
    private double getX(EntityProjectileFiendFireball fireball, float partialTickTime) {
        return fireball.prevActualPosX + (fireball.actualPosX - fireball.prevActualPosX) * partialTickTime
                - RenderManager.renderPosX;
    }

    private double getZ(EntityProjectileFiendFireball fireball, float partialTickTime) {
        return fireball.prevActualPosZ + (fireball.actualPosZ - fireball.prevActualPosZ) * partialTickTime
