...
public abstract class AbstractRenderMobEnderman extends RenderLiving {
    ...
    protected static final ResourceLocation texEndermanEyes = new ResourceLocation(
            "textures/entity/enderman/enderman_eyes.png");
    protected static final ResourceLocation texEndermanBody = new ResourceLocation(
    ...
    protected final void superDoRender(IEndermanRenderer entity, double x, double y, double z, float yaw,
            float partialTickTime) {
        super.doRender((EntityLiving) entity, x, y, z, yaw, partialTickTime);
    }

    public void renderEnderman(IEndermanRenderer entity, double x, double y, double z, float yaw,
            float partialTickTime) {
    ...
    protected void renderEquippedItems(IEndermanRenderer enderman, float partialTickTime) {
        ...
        if (carrying != null) {
            ...
            OpenGlHelper
                    .setLightmapTextureCoords(OpenGlHelper.lightmapTexUnit, brightness % 65536F, brightness / 65536F);
            GL11.glColor4f(1F, 1F, 1F, 1F);
            bindTexture(TextureMap.locationBlocksTexture);
            field_147909_c
                    .renderBlockAsItem(Block.getBlockFromItem(carrying.getItem()), carrying.getItemDamage(), 1.0F);
            GL11.glPopMatrix();
