...
public class RenderMobLouse extends RenderLiving {
    ...
    private static final ResourceLocation texLouse = new ResourceLocation(
            "hardcoreenderexpansion:textures/entity/louse.png");
    ...
    private enum RuneColor {
        ...
        RED(0.4922F, 0F, 0F),
        YELLOW(0.4922F, 0.4922F, 0F),
        GREEN(0F, 0.4922F, 0F),
        BLUE(0F, 0.369F, 0.4922F),
        PURPLE(0.327F, 0F, 0.4922F),
