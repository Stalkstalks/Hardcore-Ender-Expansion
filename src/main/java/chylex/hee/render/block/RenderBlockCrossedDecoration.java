...
public class RenderBlockCrossedDecoration implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
        ...
        float r = (colorMultiplier >> 16 & 255) / 255F, g = (colorMultiplier >> 8 & 255) / 255F,
    ...
    private void drawCrossedSquares(Block block, int meta, double x, double y, double z, float scale, float xzScaleMp,
            RenderBlocks renderer) {
        Tessellator tessellator = Tessellator.instance;
