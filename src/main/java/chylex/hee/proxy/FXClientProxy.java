...
public class FXClientProxy extends FXCommonProxy {
    ...
    @Override
    public void omnipresent(String particleName, World world, double x, double y, double z, double motionX,
            double motionY, double motionZ) {
        switch (particleName) {
            case "smoke":
                spawn(new EntitySmokeFX(world, x, y, z, motionX, motionY, motionZ));
                break;
            case "largesmoke":
                spawn(new EntitySmokeFX(world, x, y, z, motionX, motionY, motionZ, 2.5F));
                break;
            case "portal":
    ...
    @Override
    public void item(ItemStack is, World world, double x, double y, double z, double motionX, double motionY,
            double motionZ) {
        spawn(
                is.getItemSpriteNumber() == 0
                        ? new EntityDiggingFX(
                                world,
                                x,
                                y,
    ...
    @Override
    public void itemTarget(ItemStack is, World world, double startX, double startY, double startZ, final double targetX,
            final double targetY, final double targetZ, final float speedMultiplier) {
        EntityFX fx = (is.getItemSpriteNumber() == 0 ? new EntityDiggingFX(
                world,
                startX,
                startY,
                startZ,
            ...
            final ParticleBehaviorMoveTo moveBehavior = new ParticleBehaviorMoveTo(
                    this,
                    targetX,
                    targetY,
                    targetZ,
    ...
    @Override
    public void flame(World world, double x, double y, double z, double motionX, double motionY, double motionZ,
            final int maxAge) {
    ...
    @Override
    public void portalBig(World world, double x, double y, double z, double motionX, double motionY, double motionZ,
            float scaleMp, final float red, final float green, final float blue) {
        spawn(new EntityBigPortalFX(world, x, y, z, motionX, motionY, motionZ, scaleMp) {
    ...
    @Override
    public void portalColor(World world, double x, double y, double z, double motionX, double motionY, double motionZ,
    ...
    @Override
    public void magicCrit(World world, double x, double y, double z, double motionX, double motionY, double motionZ,
    ...
    @Override
    public void aura(World world, double x, double y, double z, final float red, final float green, final float blue,
            final int maxAge) {
    ...
    public void curse(World world, double x, double y, double z, CurseType type) {
        ...
        portalBig(
                ...
                y,
                z,
                (rand.nextDouble() - 0.5D) * rand.nextDouble() * 0.03D,
                (rand.nextDouble() - 0.5D) * rand.nextDouble() * 0.03D,
                (rand.nextDouble() - 0.5D) * rand.nextDouble() * 0.03D,
    ...
    public void spatialDash(World world, double x, double y, double z) {
        ...
        spawn(
                new EntityBigPortalFX(
                        world,
                        x + (rand.nextDouble() - rand.nextDouble()) * 0.3D,
                        y + (rand.nextDouble() - rand.nextDouble()) * 0.3D,
                        z + (rand.nextDouble() - rand.nextDouble()) * 0.3D,
                        (rand.nextDouble() - 0.5D) * 0.01D,
                        (rand.nextDouble() - 0.5D) * 0.01D,
                        (rand.nextDouble() - 0.5D) * 0.01D,
                        0.1F));

        for (int a = 0; a < 3; a++) {
            double motX = (rand.nextDouble() - rand.nextDouble()) * 0.0002D,
                    motY = (rand.nextDouble() - rand.nextDouble()) * 0.0002D,
                    motZ = (rand.nextDouble() - rand.nextDouble()) * 0.0002D;
    ...
    public void corruptedEnergy(World world, int x, int y, int z) {
        Random rand = world.rand;
        double motX = (rand.nextDouble() - rand.nextDouble()) * 0.2D,
                motY = (rand.nextDouble() - rand.nextDouble()) * 0.2D,
                motZ = (rand.nextDouble() - rand.nextDouble()) * 0.2D;
        spawn(
                new EntityBigPortalFX(
                        world,
                        x + 0.5D,
                        ...
                        motY,
                        motZ,
                        rand.nextBoolean() ? 1F : 1.5F + rand.nextFloat()));
    }
    ...
    @Override
    public void altarOrb(World world, double startX, double startY, double startZ, double targetX, double targetY,
            double targetZ, EssenceType essence) {
    ...
    public void energyCluster(TileEntityEnergyCluster cluster) {
        ...
        spawn(
                new EntityEnergyClusterFX(
                        cluster.getWorldObj(),
                        cluster.xCoord + 0.5D + (rand.nextDouble() - rand.nextDouble()) * 0.1D,
                        cluster.yCoord + 0.5D + (rand.nextDouble() - rand.nextDouble()) * 0.1D,
                        cluster.zCoord + 0.5D + (rand.nextDouble() - rand.nextDouble()) * 0.1D,
                        cluster.getColor(0),
                        cluster.getColor(1),
                        cluster.getColor(2),
                        cluster.data));
    ...
    @Override
    public void energyClusterMoving(World world, double x, double y, double z, double motionX, double motionY,
            double motionZ, double red, double green, double blue) {
    ...
    public void altarAura(EntityItemAltar item) {
        ...
        spawn(
                new EntityAuraFX(
                        item.worldObj,
                        item.posX + rand.nextDouble() * 0.4D - 0.2D,
                        item.posY + rand.nextDouble() * 0.4D,
                        item.posZ + rand.nextDouble() * 0.4D - 0.2D,
                        0D,
                        rand.nextDouble() * 0.05D + 0.05D,
                        0D) {
    ...
    public void igneousRockBreak(EntityItemIgneousRock rock) {
        ...
        spawn(
                new EntityBreakingFX(
                        rock.worldObj,
                        rock.posX + rand.nextDouble() * 0.4D - 0.2D,
                        rock.posY + 0.2D + rand.nextDouble() * 0.2D,
                        rock.posZ + rand.nextDouble() * 0.4D - 0.2D,
                        0D,
                        -0.015D,
                        0D,
                        ItemList.igneous_rock,
                        0) {
    ...
    public void instability(EntityItemInstabilityOrb orb) {
        ...
        double motX = (rand.nextDouble() - 0.5D) * 0.25D,
                motY = 0.12D + rand.nextGaussian() * 0.02D + rand.nextGaussian() * 0.02D,
                motZ = (rand.nextDouble() - 0.5D) * 0.25D;
    ...
    public void spatialDashExplode(EntityProjectileSpatialDash spatialDash) {
        ...
        spawn(
                new EntityBigPortalFX(
                        spatialDash.worldObj,
                        spatialDash.posX + (rand.nextDouble() - rand.nextDouble()) * 0.1D,
                        spatialDash.posY + (rand.nextDouble() - rand.nextDouble()) * 0.1D,
                        spatialDash.posZ + (rand.nextDouble() - rand.nextDouble()) * 0.1D,
    ...
    public void corruptedEnergy(EntityProjectileCorruptedEnergy energy) {
        ...
        spawn(
                new EntityBigPortalFX(
                        energy.worldObj,
                        energy.posX + (rand.nextDouble() - 0.5D) * 0.2D,
                        energy.posY + 0.5D + (rand.nextDouble() - 0.5D) * 0.2D,
                        energy.posZ + (rand.nextDouble() - 0.5D) * 0.2D,
                        motX,
                        motY,
                        motZ,
                        rand.nextBoolean() ? 0.3F : 0.4F + rand.nextFloat() * 0.4F));
    }
}
