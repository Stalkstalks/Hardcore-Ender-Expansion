...
public class ModClientProxy extends ModCommonProxy {
    ...
    public void registerRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                ...
                new RenderTexturedMob(new ModelBat(), 0.25F, "bat_vampiric.png", 0.35F));
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                ...
                new RenderTexturedMob(new ModelFireGolem(), 0.3F, "fire_golem.png"));
        RenderingRegistry.registerEntityRenderingHandler(
                EntityMobScorchingLens.class,
                new RenderTexturedMob(new ModelScorchingLens(), 0.3F, "scorching_lens.png"));
        RenderingRegistry.registerEntityRenderingHandler(
                EntityMobHauntedMiner.class,
                new RenderTexturedMob(new ModelHauntedMiner(), 0.5F, "haunted_miner.png", 1.5F));
        RenderingRegistry.registerEntityRenderingHandler(
                EntityMobEndermage.class,
                new RenderTexturedMob(new ModelEndermage(), 0.3F, "endermage.png"));
        ...
        RenderingRegistry
                .registerEntityRenderingHandler(EntityBlockEnhancedTNTPrimed.class, new RenderBlockEnhancedTNTPrimed());
        RenderingRegistry
                .registerEntityRenderingHandler(EntityBlockHomelandCache.class, new RenderBlockHomelandCache());
        ...
        RenderingRegistry.registerEntityRenderingHandler(
                EntityProjectileFiendFireball.class,
                new RenderProjectileFiendFireball(0.5F));
        RenderingRegistry.registerEntityRenderingHandler(EntityProjectileCurse.class, new RenderProjectileCurse());
        RenderingRegistry.registerEntityRenderingHandler(
                EntityProjectileExpBottleConsistent.class,
                new RenderSnowball(ItemList.exp_bottle));

        RenderingRegistry
                .registerEntityRenderingHandler(EntityWeatherLightningBoltSafe.class, new RenderLightningBolt());
        RenderingRegistry.registerEntityRenderingHandler(
                EntityWeatherLightningBoltDemon.class,
                new RenderWeatherLightningBoltPurple());
    ...
    public void registerSidedEvents() {
            ...
            public String formatString(String str) {
                ...
                try {
                    return String.format(
                            str,
                            GameSettings.getKeyDisplayString(CompendiumEventsClient.getCompendiumKeyCode()));
                } catch (Exception e) {
        ...
        AchievementManager.VOID_CHEST.setStatStringFormatter(new IStatStringFormat() {
            ...
            @Override
            public String formatString(String str) {
                return modifyVoidChestDescription ? StatCollector.translateToLocal("achievement.voidChest.notification")
                        : str;
            }
        });
        ...
        switch (msgType) {
            case TRANSPORT_BEACON_GUI:
                ...
                if (gui instanceof GuiTransportBeacon && data.length == 5) {
                    ...
                    if (beacon.centerX == data[0] && beacon.centerY == data[1] && beacon.centerZ == data[2])
                        beacon.updateStatusEvent(data[3], data[4] == 1);
                }
            ...
            case DEBUG_TITLE_SET:
                Display.setTitle(
                        Display.getTitle() + " - HardcoreEnderExpansion - "
                                + (Log.isDeobfEnvironment ? "dev" : "debug")
                                + ' '
                                + HardcoreEnderExpansion.modVersion);
                break;
        }
    }

    /**
     * Mode 0: enable on April Fools Mode 1: always enabled Mode 2: never enabled
     */
