...
public class GuiVoidChest extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int mouseX, int mouseY) {
        fontRendererObj.drawString(
                invVoidChest.hasCustomInventoryName() ? invVoidChest.getInventoryName()
                        : I18n.format(invVoidChest.getInventoryName()),
                8,
                6,
                4210752);
        fontRendererObj.drawString(
                invPlayer.hasCustomInventoryName() ? invPlayer.getInventoryName()
                        : I18n.format(invPlayer.getInventoryName()),
                8,
                ySize - 94,
                4210752);
    }
