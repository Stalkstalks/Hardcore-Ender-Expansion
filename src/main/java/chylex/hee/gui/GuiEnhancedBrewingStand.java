...
public class GuiEnhancedBrewingStand extends GuiBrewingStand {
    ...
    private static ResourceLocation guiResource = new ResourceLocation(
            "hardcoreenderexpansion:textures/gui/enhanced_brewing_stand.png");
    ...
    protected void drawGuiContainerForegroundLayer(int x, int y) {
        ...
        fontRendererObj.drawStringWithShadow(
                (brewingStand.getHoldingPowder() < powderReq ? EnumChatFormatting.YELLOW : EnumChatFormatting.WHITE)
                        + String.valueOf(powderReq),
                81,
                ySize - 114,
                0x404040);
    }
