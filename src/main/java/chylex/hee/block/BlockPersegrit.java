...
public class BlockPersegrit extends Block implements IBlockSubtypes {
    ...
    public void registerBlockIcons(IIconRegister iconRegister) {
        ...
        String[] names = new String[] { "h", "v", "hl", "hr", "vb", "vt", "tl", "tr", "bl", "br", "trb", "trl", "tbl",
                "rbl", "x" };
    ...
    public static int getConnectionMeta(LargeStructureWorld world, Random rand, int x, int y, int z) {
        ...
        if (world.getBlock(x, y - 1, z) != BlockList.persegrit || world.getBlock(x, y + 1, z) != BlockList.persegrit) { // xz
                                                                                                                        // plane
            ...
            b = isConnectable(world, x, y, z + 1);
                ...
                || world.getBlock(x + 1, y, z) != BlockList.persegrit) { // yz plane
            ...
            if (world.getBlock(x, y, z - 1) != BlockList.persegrit
                    || world.getBlock(x, y, z + 1) != BlockList.persegrit) { // xy plane
                        l = isConnectable(world, x + 1, y, z);
                        r = isConnectable(world, x - 1, y, z);
                        t = isConnectable(world, x, y + 1, z);
                        b = isConnectable(world, x, y - 1, z);
