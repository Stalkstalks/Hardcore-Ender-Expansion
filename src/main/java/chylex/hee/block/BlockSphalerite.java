...
public class BlockSphalerite extends Block implements IBlockSubtypes {
    ...
    public ArrayList<ItemStack> getDrops(World world, int x, int y, int z, int meta, int fortune) {
        if (meta == 1) return CollectionUtil.newList(
                new ItemStack(BlockList.sphalerite, 1, 0),
                new ItemStack(ItemList.stardust, 1 + world.rand.nextInt(3 + MathUtil.ceil(fortune * 0.49D)), 0));
