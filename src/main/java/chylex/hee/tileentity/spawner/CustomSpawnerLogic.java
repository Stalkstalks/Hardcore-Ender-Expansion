...
public abstract class CustomSpawnerLogic extends MobSpawnerBaseLogic {
    ...
    public boolean isActivated() {
        return getSpawnerWorld().getClosestPlayer(
                getSpawnerX() + 0.5D,
                getSpawnerY() + 0.5D,
                getSpawnerZ() + 0.5D,
    ...
    protected AxisAlignedBB getSpawnerCheckBB() {
        return AxisAlignedBB.getBoundingBox(
                ...
                getSpawnerX() + 1,
                getSpawnerY() + 1,
                getSpawnerZ() + 1).expand(spawnRange * 2D, 4D, spawnRange * 2D);
    }
    ...
    public final void func_98267_a(int i) {
        spawnerTile.getWorldObj()
                .addBlockEvent(spawnerTile.xCoord, spawnerTile.yCoord, spawnerTile.zCoord, Blocks.mob_spawner, i, 0);
    }
